...
<?php include "../../php/listar_productos.php"; ?>
    ...
    <div class="h-full px-3 py-4 overflow-y-auto text-white bg-blue-700 border-b border-gray-200 cursor-pointer dark:bg-gray-800 dark:border-gray-600 rounded-lg">
        ...
        <ul class="space-y-2 font-medium">
            ...
            foreach ($categorias as $c) {
                $idCat = $c["CategoriaID"];
                echo "<li>";
                echo "<a href='/project/assets/views/tiendacate.php?categoriaID=$idCat' class='flex items-center p-2 text-white bg-blue-700 border-b border-gray-200 cursor-pointer dark:bg-gray-800 dark:border-gray-600'>";
...
<div class="flex justify-center pl-72 space-x-1">
    <?php if ($pagActiva > $pagPrimera) { ?>
        <a href="?pag=<?php echo $pagPrevia ?>" class="min-w-9 min-h-9 font-bold rounded-md border bg-gray-800 text-white border-gray-600 py-2 px-3 text-center text-sm transition-all shadow-sm hover:shadow-lg hover:text-gray-600 hover:bg-white hover:border-gray-600 focus:text-white focus:bg-slate-800 focus:border-slate-800 active:border-slate-800 active:text-white active:bg-slate-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2">
            <
                </a>
            <?php } ?>

            <?php if ($pagActiva >= 3) { ?>
                <a href="?pag=<?php echo $pagPreviaDoble ?>" class="min-w-9 min-h-9 rounded-md border bg-gray-800 text-white border-gray-600 py-2 px-3 text-center text-sm transition-all shadow-sm hover:shadow-lg hover:text-gray-600 hover:bg-white hover:border-gray-600 focus:text-white focus:bg-slate-800 focus:border-slate-800 active:border-slate-800 active:text-white active:bg-slate-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2">
                    <?php echo $pagPreviaDoble ?>
                </a>
            <?php } ?>

            <?php if ($pagActiva >= 2) { ?>
                <a href="?pag=<?php echo $pagPrevia ?>" class="min-w-9 min-h-9 rounded-md border bg-gray-800 text-white border-gray-600 py-2 px-3 text-center text-sm transition-all shadow-sm hover:shadow-lg hover:text-gray-600 hover:bg-white hover:border-gray-600 focus:text-white focus:bg-slate-800 focus:border-slate-800 active:border-slate-800 active:text-white active:bg-slate-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2">
                    <?php echo $pagPrevia ?>
                </a>
            <?php } ?>

            <a href="?pag=<?php echo $pagActiva ?>" class="min-w-9 min-h-9 rounded-md border bg-white text-gray-600 border-gray-600 py-2 px-3 text-center text-sm transition-all shadow-sm hover:shadow-lg hover:text-gray-600 hover:bg-white hover:border-gray-600 focus:text-white focus:bg-slate-800 focus:border-slate-800 active:border-slate-800 active:text-white active:bg-slate-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2">
                <?php echo $pagActiva ?>
            </a>

            <?php if ($pagActiva < $pagFinal) { ?>
                <a href="?pag=<?php echo $pagSiguiente ?>" class="min-w-9 min-h-9 rounded-md border bg-gray-800 text-white border-gray-600 py-2 px-3 text-center text-sm transition-all shadow-sm hover:shadow-lg hover:text-gray-600 hover:bg-white hover:border-gray-600 focus:text-white focus:bg-slate-800 focus:border-slate-800 active:border-slate-800 active:text-white active:bg-slate-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2">
                    <?php echo $pagSiguiente ?>
                </a>
            <?php } ?>

            <?php if ($pagActiva < $pagPenultima) { ?>
                <a href="?pag=<?php echo $pagSiguienteDoble ?>" class="min-w-9 min-h-9 rounded-md border bg-gray-800 text-white border-gray-600 py-2 px-3 text-center text-sm transition-all shadow-sm hover:shadow-lg hover:text-gray-600 hover:bg-white hover:border-gray-600 focus:text-white focus:bg-slate-800 focus:border-slate-800 active:border-slate-800 active:text-white active:bg-slate-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2">
                    <?php echo $pagSiguienteDoble ?>
                </a>
            <?php } ?>

            <?php if ($pagActiva < $pagFinal) { ?>
                <a href="?pag=<?php echo $pagSiguiente ?>" class="min-w-9 min-h-9 font-bold rounded-md border bg-gray-800 text-white border-gray-600 py-2 px-3 text-center text-sm transition-all shadow-sm hover:shadow-lg hover:text-gray-600 hover:bg-white hover:border-gray-600 focus:text-white focus:bg-slate-800 focus:border-slate-800 active:border-slate-800 active:text-white active:bg-slate-800 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none ml-2">
                    >
                </a>
            <?php } ?>
